...
- `authoritative-materials/` contains the approved V6 workbook and Word documents.
- `questions.csv` is the website-ready extraction of the 59 authoritative questions.
...
- Roles are Team Leader (`oak`), Team Member (`maple`), and Team Supporter (`cedar`). The internal compatibility identifier for Team Supporter remains `observer`.
...
- Leader, member, and supporter responses remain visibly separate in the data portal.
